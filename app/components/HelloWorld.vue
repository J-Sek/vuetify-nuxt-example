  ...
  <v-container class="h-full flex items-center" max-width="900">
    <div>
      ...
      <div class="flex flex-wrap gap-3">
        <v-card
          class="py-4 sm:pr-[120px] w-full dark:bg-primary-800 rounded-xl"
          color="surface-variant"
          image="https://cdn.vuetifyjs.com/docs/images/one/create/feature.png"
          variant="tonal"
        >
          <template #prepend>
            <v-avatar icon="$complete" size="60" variant="tonal" class="ml-2 mr-4" />
          </template>
          ...
          <template #title>
            <h2 class="text-h5 font-medium pt-1 translate-y-1">
              Get started
            </h2>
          </template>
        ...
        <v-card
          ...
          class="
            rounded-xl
            sm:flex-basis-[40%] flex-grow-1 h-[120px] flex items-center [&>.v-card-item]:w-full
            dark:bg-linear-to-r dark:from-secondary dark:to-secondary/60
          "
          color="surface-variant"
          :href="link.href"
